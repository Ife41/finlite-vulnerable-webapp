...
- [`finlite-idor-detection`]([https://github.com/Ife41/finlite-idor-detection]): custom Semgrep rules and a CI pipeline built to catch the IDOR and header-based authorization bypass patterns used in this app.
